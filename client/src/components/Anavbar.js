  ...
  <div className="container-fluid">
    ...
    >
      <ul className="navbar-nav">
        ...
        <li className={`nav-item ${location.pathname === '/addstudent' ? 'active' : ''}`}>
          <Link className="nav-link" to="/addstudent">
            Add Student
          </Link>
        </li>
        <li className={`nav-item ${location.pathname === '/addcompany' ? 'active' : ''}`}>
          <Link className="nav-link" to="/addcompany">
            Add Company
          </Link>
        </li>
        <li className={`nav-item ${location.pathname === '/ablog' ? 'active' : ''}`}>
          <Link className="nav-link" to="/ablog">
            Add Blog
          </Link>
        </li>
